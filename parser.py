...
def get_args():
    ...
    parser.add_argument('--warmup_iter', help="Number representing the warmup iterations using labelled datapoints", type=int, default=6000)
...
# SSL common config
    ...
    parser.add_argument("--coef_schaduler", default=False, type=bool, help="schaduler for the coefficient for consistency loss")
